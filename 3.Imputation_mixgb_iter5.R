...
save(mixgb_maxit5_pmmNULL_imp, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmmNULL_imp.RData") # save imputation results
save(mixgb_maxit5_pmmNULL_time, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmmNULL_time.RData") # save time taken for imputation results
save(mixgb_maxit5_pmmNULL_eval, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmmNULL_eval.RData") # save regression results fitted on imputed data


rm(mixgb_maxit5_pmmNULL_tmp, mixgb_maxit5_pmmNULL_imp, mixgb_maxit5_pmmNULL_time, mixgb_maxit5_pmmNULL_eval)
...
save(mixgb_maxit5_pmm1_imp, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm1_imp.RData") # save imputation results
save(mixgb_maxit5_pmm1_time, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm1_time.RData") # save time taken for imputation results
save(mixgb_maxit5_pmm1_eval, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm1_eval.RData") # save regression results fitted on imputed data
...
save(mixgb_maxit5_pmm2_imp, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm2_imp.RData") # save imputation results
save(mixgb_maxit5_pmm2_time, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm2_time.RData") # save time taken for imputation results
save(mixgb_maxit5_pmm2_eval, file = "Imputation/Mixgb/iter5/mixgb_maxit5_pmm2_eval.RData") # save regression results fitted on imputed data
