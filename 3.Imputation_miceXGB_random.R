...
train_testplot(simdata,mice_G2_predicted_res, prop_values, sprintf("%s/TT_Mice_xgb_predicted_Random.pdf", dir_name))

save(mice_G2_predicted_res, file = sprintf("%s/Mice_xgb_predicted_Random.RData", dir_name))
save(eval_G2_predicted, file = sprintf("%s/Mice_xgb_predicted_Random_eval.RData", dir_name))
save(time_G2_predicted, file = sprintf("%s/time_Mice_xgb_predicted_Random.RData", dir_name))
...
train_testplot(simdata,mice_G2_predicted_observed_res, prop_values, sprintf("%s/TT_mice_G2_predicted_observed.pdf", dir_name))

save(mice_G2_predicted_observed, file = sprintf("%s/Mice_xgb_predicted_observed_Random.RData", dir_name))
save(eval_G2_predicted_observed, file = sprintf("%s/Mice_xgb_predicted_observed_Random_eval.RData", dir_name))
save(time_mice_G2_predicted_observed_res, file = sprintf("%s/time_Mice_xgb_predicted_observed_Random.RData", dir_name))
...
train_testplot(simdata,mice_G2_original_observed_res, prop_values, sprintf("%s/TT_mice_G2_original_observed.pdf", dir_name))

save(mice_G2_original_observed_res, file = sprintf("%s/Mice_xgb_original_observed_Random.RData", dir_name))
save(eval_G2_original_observed, file = sprintf("%s/Mice_xgb_original_observed_Random_eval.RData", dir_name))
save(time_mice_G2_original_observed, file = sprintf("%s/time_Mice_xgb_original_observed_Random.RData", dir_name))
